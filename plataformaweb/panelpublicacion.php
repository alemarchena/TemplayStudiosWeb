...
<head>
    ...
    <!-- ---- Select2 -------- para listas con buscador -->
    ...
    <link rel="stylesheet" type="text/css" href="cover.css?1" + r>
    ...
    <script type="text/javascript">
        ...
        function traerplataforma(id, idplataforma) {
            ...
            $.ajax({
                ...
                url: "controladores/usuariostemplay.php?3",
                data: {
                    objetojson: objetojson
                },
                type: "post",
                ...
                <div id="tarjeta" class="card text-center">
                    ...
                    <div class="">
                        ...
                        <div class="d-flex justify-content-center mt-4 row">
                            <input class="mdl-textfield__input center" onKeyUp="return verificaenter(event)" style="display:inline;width:65%;" type="text" id="email" name="email" placeholder="Email: info@templaystudios.com" value="" />
                            &nbsp;&nbsp;&nbsp;
                        </div>
                        <div class="d-flex justify-content-center mt-4 row">
                            <input class="mdl-textfield__input center" onKeyUp="return verificaenter(event)" style="display:inline;width:65%;" type="password" id="password" name="password" placeholder="Password 12345678" value="" />
                            <br /><br />
                        ...
                        <div class="d-flex justify-content-center row">
                            <button class="mdl-button mdl-js-button mdl-button--raised" disabled id="quickstart-verify-email" name="verify-email" style="visibility: hidden;">Verificar cuenta</button>
                            &nbsp;&nbsp;&nbsp;
                        </div>
