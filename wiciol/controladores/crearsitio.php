<?php
    ...
    $plataforma = json_decode($_POST['plataforma'],true);
    ...
    $sql = 'CREATE TABLE' .$dbname. '.' .$empresa. '_ajustes (
      id int(11) NOT NULL,
      ...
      ALTER TABLE ' .$dbname. '.' .$empresa .'_ajustes ADD PRIMARY KEY (id);
      ALTER TABLE ' .$dbname. '.' .$empresa .'_ajustes MODIFY id int(11) NOT NULL AUTO_INCREMENT';
